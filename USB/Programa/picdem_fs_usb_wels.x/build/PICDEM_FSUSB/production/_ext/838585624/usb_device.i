...
# 6 "C:\Program Files (x86)\Microchip\xc8\v2.00\pic\include\c90\stddef.h"
...
# 179
volatile CTRL_TRF_SETUP SetupPkt @(0x400+(((1 + 1) * 4)*4));
volatile uint8_t CtrlTrfData[8] @((0x400+(((1 + 1) * 4)*4)) + 8);
...
# 1143
pBDTEntryIn[endpoint] = (BDT_ENTRY*)(((uintptr_t)pBDTEntryIn[endpoint]) ^ 0x0004);
