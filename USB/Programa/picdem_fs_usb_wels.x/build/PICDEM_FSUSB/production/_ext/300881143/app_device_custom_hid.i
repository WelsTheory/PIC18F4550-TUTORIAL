...
extern volatile __bit  ADDR0 __at(0x7B20);


extern volatile __bit  ADDR1 __at(0x7B21);


extern volatile __bit  ADDR2 __at(0x7B22);


extern volatile __bit  ADDR3 __at(0x7B23);
...
# 18 "C:\Program Files (x86)\Microchip\xc8\v2.00\pic\include\pic18.h"
 void flash_write(const unsigned char *, unsigned int, __far unsigned char *);
...
# 48 "../demo_src/app_device_custom_hid.c"
...
# 164
pot = ADC_Read10bit(ADC_CHANNEL_0);

ToSendDataBuffer[0] = 0x37;
ToSendDataBuffer[1] = (uint8_t)pot;
ToSendDataBuffer[2] = pot >> 8;
